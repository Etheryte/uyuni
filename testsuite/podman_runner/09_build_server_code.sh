...
sudo -i podman exec server bash -c "zypper -n install tmate"
sudo -i podman exec server bash -c "timeout 600 tmate"
# sudo -i podman exec server bash -c "rpm -ql nodejs22"
# sudo -i podman exec server bash -c "rpm -ql nodejs22"
# sudo -i podman exec server bash -c "/usr/bin/npm"
