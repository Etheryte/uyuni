...
export function PackageList(props: Props) {
  ...
  const deleteButton = [
    <AsyncButton defaultType="btn-warning" text={t("Delete")} icon="fa-trash" action={() => setOpen(true)} />,
  ];
  ...
  return (
    <>
      ...
      <p>
        You may delete packages owned by your organization. The "view packages in channels" select box allows you to
        restrict the set of packages you will view. To delete a package, check the box next to it and click 'Confirm
        Deletion', below.
      </p>
